    ...
    <div style={{ padding: 28, maxWidth: 860, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24, gap: 12, flexWrap: 'wrap' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <h1 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 900, fontSize: 20, letterSpacing: '-0.04em', color: C.text, marginBottom: 2 }}>{course.title}</h1>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          <button onClick={saveCourse} disabled={saving} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '9px 16px', borderRadius: 10, background: 'linear-gradient(135deg, #7C3AED, #9F67FF)', color: '#fff', border: 'none', cursor: 'pointer', fontSize: 13, fontFamily: 'Syne, sans-serif', fontWeight: 700 }}>
      ...
      <div style={{ background: C.bg1, border: `1px solid ${C.border}`, borderRadius: 20, overflow: 'hidden', marginBottom: 16 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px', borderBottom: `1px solid ${C.border}` }}>
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 14, color: C.text }}>Contenido del curso</h2>
            ...
            {expandedMod === mod.id && (
              <div style={{ background: '#0A0A10', borderTop: `1px solid ${C.border}`, padding: '8px 14px 16px' }}>
                ...
                <div style={{ background: C.bg1, borderRadius: 14, padding: 14, marginTop: 8, border: `1px solid ${C.border}` }}>
                  <div style={{ fontSize: 11, fontWeight: 700, color: C.muted, fontFamily: 'Syne, sans-serif', letterSpacing: '0.05em', textTransform: 'uppercase', marginBottom: 10 }}>+ Nueva lección</div>
