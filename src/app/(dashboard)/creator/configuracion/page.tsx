  ...
  return (
    <div style={{ padding: 28, maxWidth: 660, margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 28 }}>
        ...
        <div>
          <h1 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 900, fontSize: 24, letterSpacing: '-0.04em', color: C.text, marginBottom: 2 }}>⚙️ Permisos</h1>
      ...
      <div style={{ background: C.bg1, border: `1px solid ${C.border}`, borderRadius: 20, padding: '4px 20px 0', marginBottom: 14 }}>
        <div style={{ padding: '14px 0 10px', borderBottom: `1px solid ${C.border}` }}>
          <div style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 14, color: C.text }}>💬 Foro</div>
        </div>
      ...
      <div style={{ background: C.bg1, border: `1px solid ${C.border}`, borderRadius: 20, padding: 20, marginBottom: 14 }}>
        <div style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 14, color: C.text, marginBottom: 14 }}>💭 Chat</div>
        {[
      ...
      <div style={{ background: C.bg1, border: `1px solid ${C.border}`, borderRadius: 20, padding: '4px 20px 0', marginBottom: 24 }}>
        <div style={{ padding: '14px 0 10px', borderBottom: `1px solid ${C.border}` }}>
          <div style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 14, color: C.text }}>❓ Q&A</div>
        </div>
