        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '12px 24px', borderBottom: `1px solid ${C.border}` }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              <span style={{ fontFamily: 'Syne, sans-serif', fontWeight: 900, fontSize: 16, color: C.text, letterSpacing: '-0.02em' }}>{community.name}</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            {isOwner && (
              <Link href="/creator" style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '7px 14px', borderRadius: 9, background: 'rgba(99,102,241,0.12)', border: `1px solid rgba(99,102,241,0.25)`, color: C.purple2, textDecoration: 'none', fontSize: 12, fontWeight: 700, fontFamily: 'Syne, sans-serif' }}>
