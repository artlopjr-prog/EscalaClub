        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '10px 24px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <span style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 900, fontSize: 15, color: '#E8E9F0', letterSpacing: '-0.02em' }}>
                {community.name}
              </span>
          ...
          <div className="community-header-stats" style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 800, fontSize: 15, color: '#E8E9F0' }}>{community.member_count ?? 0}</div>
              <div style={{ fontSize: 10, color: 'rgba(255,255,255,0.35)' }}>miembros</div>
            </div>
            {isOwner && (
              <Link href="/creator/comunidad" style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '7px 14px', borderRadius: 9, background: `${accent}20`, border: `1px solid ${accent}40`, color: accent, textDecoration: 'none', fontSize: 12, fontWeight: 700, fontFamily: 'Outfit, sans-serif', whiteSpace: 'nowrap' }}>
