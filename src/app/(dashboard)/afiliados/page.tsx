  ...
  return (
    <div style={{ padding: 32, maxWidth: 800, margin: '0 auto' }}>
      <div style={{ marginBottom: 32 }}>
        <h1 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 900, fontSize: 34, letterSpacing: '-0.04em', color: C.text, marginBottom: 4 }}>Programa de Afiliados 🤝</h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 14, marginBottom: 28 }}>
        {[
          ...
          <div key={i} style={{ background: C.bg1, border: `1px solid ${C.border}`, borderRadius: 16, padding: 20 }}>
            ...
            <div style={{ fontFamily: 'Syne, sans-serif', fontWeight: 900, fontSize: 28, color: s.color, letterSpacing: '-0.04em' }}>{s.value}</div>
      ...
      <div style={{ background: C.bg1, border: `1px solid ${C.border}`, borderRadius: 20, padding: 28, marginBottom: 20 }}>
        <h2 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 16, color: C.text, marginBottom: 16 }}>Tu enlace de referido</h2>
        <div style={{ display: 'flex', gap: 10 }}>
          ...
          <button
            ...
            style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '12px 18px', borderRadius: 12, background: 'linear-gradient(135deg, #7C3AED, #9F67FF)', color: '#fff', border: 'none', cursor: 'pointer', fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 13, whiteSpace: 'nowrap' }}>
            <Copy size={14} /> Copiar
          </button>
        </div>
      ...
      <div style={{ background: 'rgba(240,165,0,0.06)', border: '1px solid rgba(240,165,0,0.2)', borderRadius: 20, padding: 24, textAlign: 'center' }}>
        ...
        <h3 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 16, color: C.text, marginBottom: 8 }}>Dashboard de afiliados en construcción</h3>
