...
export default function PayPalSetupPage() {
  ...
  return (
    <div style={{ padding: '40px 32px', maxWidth: 700, margin: '0 auto' }}>
      <h1 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 900, fontSize: 28, marginBottom: 8 }}>
        ⚙️ Setup PayPal
      </h1>
...
{result.env_vars}
            ...
            <button
              ...
              style={{ marginTop: 12, padding: '8px 16px', borderRadius: 8, background: 'var(--bg3)', border: '1px solid var(--border2)', color: 'var(--muted2)', fontSize: 12, cursor: 'pointer', fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
              📋 Copiar todo
            </button>
          </div>
