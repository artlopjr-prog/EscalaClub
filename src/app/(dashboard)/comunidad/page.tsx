  ...
  if (!membership?.community_id) {
    return (
      <div style={{ padding: 32, textAlign: 'center', maxWidth: 500, margin: '80px auto' }}>
        ...
        <h2 style={{ fontFamily: 'Inter, sans-serif', fontWeight: 900, fontSize: 24, color: 'var(--text)', marginBottom: 12 }}>Sin comunidades aún</h2>
        <p style={{ fontSize: 15, color: 'var(--muted)', marginBottom: 24, lineHeight: 1.6 }}>Únete a una comunidad para acceder a su foro y conectar con sus miembros.</p>
