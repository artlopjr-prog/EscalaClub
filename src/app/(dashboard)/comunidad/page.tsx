  ...
  if (!membership?.community_id) {
    return (
      <div style={{ padding: 32, textAlign: 'center', maxWidth: 500, margin: '80px auto' }}>
        ...
        <h2 style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 900, fontSize: 24, color: '#EEEDF5', marginBottom: 12 }}>Sin comunidades aún</h2>
        ...
        <Link href="/comunidades" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '12px 24px', borderRadius: 12, background: 'linear-gradient(135deg, #7C3AED, #9F67FF)', color: '#fff', textDecoration: 'none', fontFamily: 'Outfit, sans-serif', fontWeight: 700, fontSize: 14 }}>
