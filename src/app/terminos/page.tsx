  ...
  return (
    <div style={{ minHeight: '100vh', background: C.bg, color: C.text, fontFamily: 'Outfit, sans-serif' }}>
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <h1 style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 900, fontSize: 40, letterSpacing: '-0.04em', marginBottom: 12 }}>Términos y Condiciones</h1>
        ...
        {[
          ...
          <div key={section.title} style={{ marginBottom: 36 }}>
            <h2 style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 800, fontSize: 18, marginBottom: 12, color: C.text }}>{section.title}</h2>
