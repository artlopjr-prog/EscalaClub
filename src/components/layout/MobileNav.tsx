    ...
    <>
      ...
      <nav style={{
        ...
        {NAV.map(item => {
          ...
          return (
            <Link key={item.href} href={item.href} style={{ textDecoration: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3, padding: '6px 14px', borderRadius: 10, minWidth: 52 }}>
              ...
              <span style={{ fontSize: 10, fontWeight: active ? 700 : 400, color: active ? C.purple2 : C.muted, fontFamily: 'Syne, sans-serif' }}>
                {item.label}
              </span>
            </Link>
          )
        ...
        >
          ...
          <span style={{ fontSize: 10, color: C.muted, fontFamily: 'Syne, sans-serif' }}>Más</span>
        </button>
      </nav>
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 20px 16px' }}>
              <span style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 17, color: C.text }}>Menú</span>
            ...
            <div style={{ padding: '0 16px 16px' }}>
              <div style={{ fontSize: 10, fontFamily: 'Syne, sans-serif', fontWeight: 700, color: C.muted, letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 10, paddingLeft: 4 }}>
                👤 Miembro
              </div>
            ...
            {isCreator && (
              <div style={{ padding: '0 16px 16px', borderTop: `1px solid ${C.border}`, paddingTop: 16 }}>
                <div style={{ fontSize: 10, fontFamily: 'Syne, sans-serif', fontWeight: 700, color: '#F0A500', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 10, paddingLeft: 4 }}>
                  ⚡ Creador
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
