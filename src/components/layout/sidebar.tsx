...
export function Sidebar({ user, unread, isCreator }: Props) {
  ...
  return (
    <div style={{
      ...
      {/* Section label */}
      {!collapsed && (
        <div style={{ padding: '10px 16px 4px', fontSize: 10, fontFamily: 'Syne, sans-serif', fontWeight: 700, color: modeColor, letterSpacing: '0.08em', textTransform: 'uppercase', opacity: 0.7 }}>
      ...
      {!collapsed && (
        <div style={{ padding: '8px 14px', borderTop: `1px solid ${C.border}`, flexShrink: 0 }}>
          <button
            ...
            style={{ width: '100%', display: 'flex', alignItems: 'center', gap: 8, padding: '7px 10px', borderRadius: 9, background: 'rgba(255,255,255,0.04)', border: `1px solid ${C.border}`, cursor: 'pointer', color: C.muted, fontSize: 11, fontFamily: 'Plus Jakarta Sans, sans-serif', fontWeight: 500 }}>
      ...
      <div style={{ borderTop: `1px solid ${C.border}`, padding: collapsed ? '10px 0' : '12px 14px', flexShrink: 0, background: 'rgba(0,0,0,0.15)' }}>
        {!collapsed ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ width: 34, height: 34, borderRadius: '50%', background: 'rgba(99,102,241,0.2)', border: '2px solid rgba(99,102,241,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 13, color: C.purple2, flexShrink: 0, overflow: 'hidden' }}>
